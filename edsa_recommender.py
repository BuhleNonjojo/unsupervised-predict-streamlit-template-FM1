...
#-----------------------------------------About Us Page---------------------------------------------------------------------------------------------------
    ...
    if page_selection == "About Us":
        ...
        with st.container():
            ...
            with image_column:
                Buhle = Image.open("resources/imgs/IMG_6150.JPG")
                st.image(Buhle)
            with text_column:
                st.subheader("Director: Buhle Nonjojo")
        ...
        with st.container():
            image_column, text_column = st.columns((1, 2))
            with image_column:
                Dikeledi = Image.open("resources/imgs/IMG-20240214-WA0062.jpg")
                st.image(Dikeledi)
            with text_column:
                st.subheader("Data Analyst: Dikeledi Ramohlola")
                st.write("Dikeledi's passion for data science goes beyond she professional work. In his free time, she enjoys participating in Kaggle competitions, where he applies his skills to real-world datasets and collaborates with other data scientists worldwide. He is also an avid reader of data science literature and actively contributes to the data science community by sharing his knowledge. The same dedication she puts in when preparing her mouth watering dishes. A professional chef too.")
        with st.container():
            image_column, text_column = st.columns((1, 2))
            with image_column:
            ...
            with text_column:
                    ...
                    st.write("Ndumiso an accomplished data scientist with a passion for extracting insights from complex datasets. With a strong background in statistics, mathematics, and programming, he leverages his expertise to tackle challenging analytical problems. Our award winnng author who has won  over 20 writing competitions around the world.")
        with st.container():
            image_column, text_column = st.columns((1, 2))
            with image_column:
                Edna = Image.open("")
